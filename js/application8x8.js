$(document).ready(function(){
  ...
  var randomNumberGeneration = function(){
    ...
    while (generated==false){
      var colNum=Math.floor(Math.random()*7.99+1);
      var rowNum=Math.floor(Math.random()*7.99+1);
  ...
  var leftMove = function(){
  	...
  	for (i=1; i<=8; i++){
  		...
  		while(($('#'+gridRow).children('#column2').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column3').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column4').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column5').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column6').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column7').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column8').attr('myAttr')=='canMove')){
  			for (j=2; j<=8; j++){
  				gridCol="column"+j;
  ...
  var rightMove = function(){
    ...
    for (i=1; i<=8; i++){
      gridRow="grid_"+i;
      $('#'+gridRow).children('#column8').attr('myAttr','cantMove');
      while(($('#'+gridRow).children('#column1').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column2').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column3').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column4').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column5').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column6').attr('myAttr')=='canMove')||($('#'+gridRow).children('#column7').attr('myAttr')=='canMove')){
        for (j=7; j>=1; j--){
          gridCol="column"+j;
          gridColPrev="column"+(j+1);
          if($('#'+gridRow).children('#'+gridCol).text()!="0"){
  ...
  var upMove = function(){
    ...
    for (i=1; i<=8; i++){
      ...
      while(($('#grid_2').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_3').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_4').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_5').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_6').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_7').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_8').children('#'+gridCol).attr('myAttr')=='canMove')){
        for (j=2; j<=8; j++){
          gridRow="grid_"+j;
  ...
  var downMove = function(){
    ...
    for (i=1; i<=8; i++){
      gridCol="column"+i;
      $('#grid_8').children().attr('myAttr','cantMove');
      while(($('#grid_2').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_3').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_1').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_4').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_5').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_6').children('#'+gridCol).attr('myAttr')=='canMove')||($('#grid_7').children('#'+gridCol).attr('myAttr')=='canMove')){
        for (j=7; j>=1; j--){
          gridRow="grid_"+j;
          gridRowPrev="grid_"+(j+1);
          if($('#'+gridRow).children('#'+gridCol).text()!="0"){
